...
{
    public $lang, $languages, $countries, $districts, $upazilas;
    ...
    public function index()
    {
        ...
        $listTh = [
            ...
            'upazila' => trans('customer.upazila'),
            'post' => trans('customer.post'),
            'country' => trans('customer.country'),
            'educational_institute' => trans('customer.educational_institute'),
            'birthdate' => trans('customer.birthdate'),
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[] = [
                ...
                'upazila' => $this->upazilas[$row['upazila']]->name ?? '',
                'post' => $row['post'],
 ...
 */
    public function create()
    {
        $data = [
            ...
            'upazilas' => (new ShopUpazila)->getList(),
            'customer' => [],
