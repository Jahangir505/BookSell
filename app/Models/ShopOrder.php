 ...
 */
    public function createOrder($dataOrder, $dataTotal, $arrCartDetail)
    {
        try {
            ...
            $dataOrder['address'] = sc_clean($dataOrder['address']);
            $dataOrder['district'] = sc_clean($dataOrder['district']);
            $dataOrder['upazila'] = sc_clean($dataOrder['upazila']);
            $dataOrder['post'] = sc_clean($dataOrder['post']);
            ...
            foreach ($arrCartDetail as $cartDetail) {
                ...
                $cartDetail['vendor_id'] = $product->vendor_id;
