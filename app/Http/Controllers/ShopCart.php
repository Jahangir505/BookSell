...
class ShopCart extends GeneralController
{
    ...
    public function __construct()
    {
        ...
        $this->upazilas = ShopUpazila::getList();
    }
/**
 ...
 */
    public function getCart()
    {
        ...
        if ($user) {
            ...
            session()->forget('shippingAddress'); //destroy shippingAddress
            $addressDefaul = [
                'first_name' => '',
                'last_name' => '',
                'email' => '',
    ...
    public function getCheckout()
    {
        ...
        return view('templates.' . sc_store('template') . '.shop_checkout',
            array(
                ...
                'shippingAddress' => $shippingAddress,
                'countries' => ShopCountry::getArray(),
                'district' => $this->districts[$shippingAddress['district']]->name ?? '',
                'upazila' => $this->upazilas[$shippingAddress['upazila']]->name ?? '',
 ...
 */
    public function addOrder(Request $request)
    {
        ...
        $dataOrder['upazila'] = $shippingAddress['upazila'];
        $dataOrder['post'] = $shippingAddress['post'];
        ...
        foreach (Cart::content() as $cartItem) {
            ...
            $arrDetail['vendor_id'] = $cartItem->vendor_id;
