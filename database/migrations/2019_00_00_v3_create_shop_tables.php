...
<script>
  ...
  gtag(\'config\', \'UA-128658138-1\');
        ...
        DB::table('shop_link')->insert([
            ...
            ['name' => 'S-Cart', 'url' => 'https://bookimind.com', 'target' => '_blank', 'module' => '', 'group' => 'menu', 'status' => '1', 'sort' => '0'],
