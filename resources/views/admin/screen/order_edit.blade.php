          ...
          <div class="row" id="order-body">
            <div class="col-sm-6">
                 <table class="table table-bordered">
                    ...
                    <tr>
                      <td class="td-title">{{ trans('order.shipping_address') }}:</td><td><a href="#" class="updateInfoRequired" data-name="address" data-type="text" data-pk="{{ $order->id }}" data-url="{{ route("admin_order.update") }}" data-title="{{ trans('order.address') }}" >{!! $order->address !!}</a></td>
                    </tr>
                    <tr>
                      <td class="td-title">{{ trans('order.shipping_district') }}:</td><td><a href="#" class="updateInfoRequired" data-name="district" data-type="select" data-source ="{{ json_encode($districtMap) }}" data-pk="{{ $order->id }}" data-url="{{ route("admin_order.update") }}" data-title="{{ trans('order.district') }}" data-value="{!! $order->district !!}"></a></td>
                    </tr>
                    <tr>
                      <td class="td-title">{{ trans('order.shipping_upazila') }}:</td><td><a href="#" class="updateInfoRequired" data-name="upazila" data-type="select" data-source ="{{ json_encode($upazilaMap) }}" data-pk="{{ $order->id }}" data-url="{{ route("admin_order.update") }}" data-title="{{ trans('order.upazila') }}" data-value="{!! $order->upazila !!}"></a></td>
                    </tr>
                    <tr>
                      <td class="td-title">{{ trans('order.shipping_post') }}:</td><td><a href="#" class="updateInfoRequired" data-name="post" data-type="text" data-pk="{{ $order->id }}" data-url="{{ route("admin_order.update") }}" data-title="{{ trans('order.post') }}" >{!! $order->post !!}</a></td>
                    </tr>
                      <tr>
            ...
            <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="not-print">{{ trans('admin.action') }}</th>
                  </tr>
                </thead>
                <tbody>
                    @foreach ($order->details as $item)
                          <tr>
                            ...
                            <td>{{ $shop->getVendor($item->vendor_id) ? $shop->getVendor($item->vendor_id)->address : 'Dhaka, Bangladesh' }}</td>
