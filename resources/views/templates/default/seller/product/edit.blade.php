        ...
        <div class="row">
           ...
           <div class="col-md-12">
              <div class="box">
                 <div class="row box-header with-border">
                    ...
                    <div class="col-md-6 box-tools">
                        <div class="btn-group pull-right" style="margin-right: 5px">
                            <a href="{{ route('product.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{trans('admin.back_list')}}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
                ...
                <!-- form start -->
                <form action="{{ route('product.edit',['id'=>$product['id']]) }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"  enctype="multipart/form-data">
...
{{-- writer name --}}
                                ...
                                <div class="form-group   {{ $errors->has('writer') ? ' has-error' : '' }}">
                                    <label for="writer" class="col-sm-2  control-label">{{ trans('product.writer') }}</label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                            <input type="text" id="writer" name="writer" value="{!! old('writer',$product->writer) !!}" class="form-control input-sm writer" placeholder="" />
                                        </div>
...
{{-- Status --}}
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-10">
                                   <input type="checkbox" name="status"  {{ old('status',(empty($product['status'])?0:1))?'checked':''}}>
                                </div>
                            </div>
{{-- //Virtual --}}
...
{{-- <hr>
                            <div class="form-group {{ $errors->has('productInGroup') ? ' has-error' : '' }}">
                                <label class="col-sm-2 control-label"></label>
                                <div class="col-sm-10"><label>{{ trans('product.admin.select_product_in_group') }}</label></div>
                            </div>
                            <div class="form-group {{ $errors->has('productInGroup') ? ' has-error' : '' }}">
                                <div class="col-sm-2">
                                </div>
