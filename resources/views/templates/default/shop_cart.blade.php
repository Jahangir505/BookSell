...
{{-- //end Process attributes --}}
  ...
  @guest
  <div class="col-sm-12">
    <h3 class="text-center"> Please <a href="{{ route('login') }}"><i class="fa fa-lock"></i> Login or Signup </a> for checkout</h3>
  </div>
  @else

  <form class="shipping_address cart-checkout" id="form-order" role="form" method="POST" action="{{ route('checkout') }}">
<div class="row">
    <div class="col-md-6 col-xs-12">
            @csrf
            <table class="table  table-bordered table-responsive">
                <tr>
                <td class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }} col-xs-6">
                    ...
                    <td class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }} col-xs-6">
                ...
                <tr>
                    ...
                    <td class="form-group{{ $errors->has('phone') ? ' has-error' : '' }} col-xs-6">
                ...
                <tr>
                    <td class="form-group{{ $errors->has('address') ? ' has-error' : '' }}"><label for="address" class="control-label"><i class="fa fa-home"></i> {{ trans('cart.address') }}:</label> <input name="address" type="text" placeholder="{{ trans('cart.address') }}" value="{{ (old('address'))?old('address'):$shippingAddress['address']}}">
                            @if($errors->has('address'))
                                <span class="help-block">{{ $errors->first('address') }}</span>
                            @endif</td>
                    <td class="form-group{{ $errors->has('district') ? ' has-error' : '' }}">
                        <label  for="district" class="control-label"><i class="fa fa-dribbble" aria-hidden="true"></i> {{ trans('cart.district') }}:</label>
                        @php
                            $ct = (old('district'))?old('district'):$shippingAddress['district'];
                        @endphp
                        <select class="form-control district " style="width: 100%;" name="district" >
                            <option value="">__{{ trans('cart.district') }}__</option>
                ...
                <tr>
                    <td class="form-group{{ $errors->has('upazila') ? ' has-error' : '' }}">
                        <label  for="upazila" class="control-label"><i class="fa fa-dribbble" aria-hidden="true"></i> {{ trans('cart.upazila') }}:</label>
                        @php
                            $ct = (old('upazila'))?old('upazila'):$shippingAddress['upazila'];
                        @endphp
                        <select class="form-control upazila " style="width: 100%;" name="upazila" >
                            <option value="">__{{ trans('cart.upazila') }}__</option>
                    ...
                    <td class="form-group{{ $errors->has('post') ? ' has-error' : '' }}"><label for="post" class="control-label"><i class="fa fa-university"></i> {{ trans('cart.post') }}</label><input name="post" type="text" placeholder="{{ trans('cart.post') }}" value="{{ (old('post'))?old('post'):$shippingAddress['post']}}">
                            @if($errors->has('post'))
