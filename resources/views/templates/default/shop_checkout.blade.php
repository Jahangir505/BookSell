...
<form class="shipping_address cart-checkout" id="form-order" role="form" method="POST" action="{{ route('addOrder') }}">
    {{ csrf_field() }}
    <div class="row">
    <div class="col-md-6">
        ...
        <table class="table box table-bordered" id="showTotal">
            ...
            <tr>
             ...
             <tr>
                ...
                <td>{{ $shippingAddress['address'].', '.$upazila.', '.$district.' - '.$shippingAddress['post'].', '.$shippingAddress['country'] }}</td>
            </tr>
             <tr>
