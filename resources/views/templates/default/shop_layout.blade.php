...
<head>
    ...
    <meta name="description" content="{{ $description??sc_store('description') }}. BOOKiMIND is an online marketplace startup by one entrepreneur in 2019 where customers will get rich and beautiful collection of different books from different shops.
We have hundreds of trusted book seller who are offering millions of books through BOOKiMIND. Here you can find new books as well as used books. One can have own business only based on this market palce by selling books through BOOKiMIND. Our epic collections and different business policies is helping both customers and sellers. Customers are getting independent options to choose and sellers are in competitive market to sell their books.">
    <meta name="keyword" content="{{ $keyword??sc_store('keyword') }}. Bookshop, Books, Ecommerce, Book sell, Bookimind, book i mind">
    ...
    <link rel="shortcut icon" href="{{asset('data/logo/favicon.png')}}" type="image/x-icon">
<!--Module meta -->
