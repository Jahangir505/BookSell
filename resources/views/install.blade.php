...
<div class="container">
    ...
    <div class="col-md-4 col-sm-8">
        ...
        <div class="btn-group">
        <button type="button" class="btn btn-default dropdown-toggle usa" data-toggle="dropdown"><img src="https://bookimind.com/documents/website/language/flag_uk.png" style="height: 25px;">
        <span class="caret"></span>
      </button>
          <ul class="dropdown-menu" >
              <li><a href="install.php"><img src="https://bookimind.com/documents/website/language/flag_uk.png" style="height: 25px;"></a></li>
              <li><a href="install.php?lang=vi"><img src="https://bookimind.com/documents/website/language/flag_vn.png" style="height: 25px;"></a></li>
          </ul>
        </div>
