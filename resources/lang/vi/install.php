...
return [
    'info' => [
        ...
        'about_us' => '- Để hiểu thêm về chúng tôi, hãy ghé thăm <a target="_new" href="https://bookimind.com/">Trang chủ của S-Cart</a>',
        'document' => '- Tài liệu hướng dẫn cài đặt <a target="_new" href="https://bookimind.com/installation.html">TẠI ĐÂY</a>',
        'version' => 'Phiên bản',
        'terms' => '<span style="color:red">*</span> Vui lòng đọc điều kiện trước khi cài đặt <a target="_new" href="https://bookimind.com/license.html">Ở ĐÂY</a>.',
        'terms_pro' => '<span style="color:red">*</span> Vui lòng đọc điều kiện trước khi cài đặt <a target="_new" href="https://bookimind.com/pro.html">Ở ĐÂY</a>.',
    ],
    'env' => [
